<?php
    ...
    require 'php/EditDataFunctions.php';
?>
<!DOCTYPE html>
<html lang="en" >
...
<head>
    ...
    <title>kawelo Lawyers | Appointments-Edit</title>
                    ...
                    <div class="col ">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Cases.html">Appointments</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Edit an Appointments</li>
                            </ol>
                        </nav>
                        <h4 class="page-title">Edit an Appointments</h4>
                        <hr>
                    </div>
                </div>
            </div>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="page-title-box10">
                                        <label class="page-title ml-3 font-10">Appointments</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <?php 
                                        $output = getAppointments($conn, $ID);
                                        echo "$output";
                                    ?>
                                </div>
                                <div class="row mt-3 ml-auto">
                                    <button id="save_button" type="button" class="btn btn-secondary">submit</button>
                                </div>
                            </form>
...
<script type="text/javascript" src="http://localhost/Kawelo Lawyers/js/editFunction.js"></script>
...
<script src="http://localhost/Kawelo Lawyers/assets/fancybox.min.js" type="text/javascript"></script>
