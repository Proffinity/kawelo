            ...
            <ul class="navbar-right list-inline float-right mb-0">
                ...
                <li class="dropdown notification-list list-inline-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-sm-left p-2 nav">
                        <a href="pages-login.html" class="nav-item align-items-center">
    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="row justify-content-end">
                <div class="col">
                    <p class="text-right">
                        <a href="inputAppointments.php" class="btn btn-primary">
                            <i class="icon-profile-add"></i> Add an Appointment
                        </a>
                    </p>
                </div>
            </div>
