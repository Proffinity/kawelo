    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <?php require 'php/updateUser.php'; ?>
                    <form method="POST" enctype="multipart/form-data" action="">

                        <?php
                            $display = getUserDetails($getID, $conn);
                            echo "$display";
                        ?>

                        <div class="row mt-3 ml-auto">
                            <button name="update_user" id="save_user" type="submit" class="btn btn-secondary">submit</button>&nbsp;
                            <button name="update_user" id="save_user" type="submit" class="btn btn-secondary">Upload Picture</button>&nbsp;
                            <button name="update_user" id="save_user" type="submit" class="btn btn-secondary">Change User Password</button>
                        </div>
