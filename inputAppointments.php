...
<head>
    ...
    <title>kawelo Lawyers | Appointments</title>
                    ...
                    <div class="col ">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Appointments</li>
                            </ol>
                        </nav>
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="row mt-3 ml-auto">
                                    <button id="appointments_save" type="button" class="btn btn-secondary">submit</button>
                                </div>
                            </form>
